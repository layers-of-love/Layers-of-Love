  ...
  return (
    <div className={styles.container}>
      <div className={styles.introText}>
        ...
        <p className={styles.subtitle}>Find us on <span className={styles.link}><a href='https://www.instagram.com/explore/tags/LayersOfLoveRMG/' className={styles.link} target='_blank' rel='noreferrer'>#LayersOfLoveRMG</a></span>!</p>
      </div>
    </div>
  )
}
