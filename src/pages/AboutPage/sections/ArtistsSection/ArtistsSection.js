...
export default function ArtistsSection() {
  let khadijaBio = (
    <p>Khadija Aziz (she/her) investigates image-making with textiles using manipulation, experimentation, and the ever-shifting nature of cloth. Her process-based practice bridges the gaps between textile-making techniques and digital technologies to generate unexpected outcomes through translation, chance, and distortion. She is currently pursuing an MFA at Concordia University’s Fibre & Material Practices program. In recognition of her creative practice, she has most recently received the Shanks Memorial Award in Textiles from Craft Ontario and the Creative Promise Award from Surface Design Association in 2020.</p>
  );

  let lauraBio = (
    <p>Laura Kay Keeling (she/her/they) is a visual artist living and working inT’karonto. Her work encompasses analog photography, video, collage and installation-based projects. Exploring and unpacking emotions through the creation of new work, while examining concepts related to “the visitor” as spoken about in Rumi’s Poem ‘The Guest House’. Laura feels very connected to and at peace in nature; her new works explore ideas relating to plant sentience and reciprocal care. Her work has recently been published in The Walrus and she recently launched a solo virtual exhibition of digital works set in a naturalistic landscape as part of CONTACT photography festival titled The Advantages of Tender Loving Care.</p>
  );

  let kayaBio = (
    <p>kaya joan is a multi-disciplinary Afro-Indigenous artist living in T’karonto, Dish with One Spoon treaty territory. kaya’s work is centred in healing practices, transcending linear notions of time, blood memory and relationship to place. Rooting themself in frameworks of Black and Indigenous futuritist pedagogy, kaya engages with methods of making that operate as ancestral tools to unpack and transform buried truths, opening portals 7 generations into the past and future. <br/><br/>kaya has also been working as a community arts facilitator for the past 6 years, and are a member of the Milkweed Collective. <br/><br/>kaya graduated from OCADU’s Indigenous Visual Art’s program in 2020, and was the recipient of the INVC medal, Nora E. Vaughan Award and Akin Studio’s Career Launcher grant. </p>
  );

  let nicoleBio = (
    <p>Nicole Krstin is a Filipinx visual artist whose work imagines the internal mechanisms and processes of transformation, with a focus on the ubiquitous nature of an inspired and evolving societal landscape. Nicole is represented by Wall Space Gallery in Ottawa. Nicole currently works and lives with her family in the traditional Treaty 7 Territory.</p>
  );

  let yahnBio = (
    <p>Yahn Nemirovsky (they/them) is an artist, craftsperson, educator, and graduate of OCAD University's Textiles program. They are interested in the intersections of textile and paper media practices, and in their making they take inspiration from the intimate object worlds of perzines and stitching samplers. They combine practices of embroidery, collage, drawing, weaving, quilting, watercolour painting, paper making and appliqué in creating hybrid objects that are given a first person voice with stitched text. In making these objects, Yahn seeks to facilitate an experience wherein it is felt that the viewer and the object both know something deeply true about one another.<br/><br/>Yahn's textile work has been exhibited at Xpace Cultural Centre, the Artist Project, and as part of the Bi Arts Festival since its inception in 2017, at Beaver Hall Gallery, Glory Hole Gallery, and D-Beatstro.
    </p>
  );
